...
public class svm_toy extends Applet {
    private static final long serialVersionUID = -4604824692259017727L;
	...
	void button_save_clicked(String args) {
		...
		try {
			...
			if (svm_type_idx != -1) {
				StringTokenizer svm_str_st = new StringTokenizer(args
				        .substring(svm_type_idx + 2).trim());
...
class AppletFrame extends Frame {
    private static final long serialVersionUID = -2708037313424147656L;
