...
/**
 * This class provides some file processing utilities such as read/write files,
...
public class FileUtils {
	 ...
	 */
	public static boolean write(String filename, String encoding,
	        String strToWrite) {
	...
	public static void copyFile(String srcFile, String dstFile) {
		try {
			...
			try {
				...
				System.out.println("Error in FileUtils.copyFile: "
				        + e.toString());
			} finally {
				if (fis != null)
					fis.close();
	 ...
	 * @param files
	 *            The files to be copied. NOTE THAT this list contains only
	 *            names (WITHOUT PATH).
	 */
	 ...
	 * 
	 * @param file_input
	 *            Input file to gunzip.
	 * @param dir_output
	 *            Output directory to contain the ungzipped file (whose name =
	 *            file_input - ".gz")
	...
	public static int gunzipFile(File file_input, File dir_output) {
		...
		String file_output_name = file_input_name.substring(0,
		        file_input_name.length() - 3);
	 ...
	 * 
	 * @param inputFile
	 *            The input file to gzip.
	 * @param gzipFilename
	 *            The gunzipped file's name.
