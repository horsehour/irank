...
public class BestAtKScorer extends MetricScorer {
	...
	/**
	 * Return the position of the best object (e.g. docs with highest degree of
	 * relevance) among objects in the range [0..k] NOTE: If you want best-at-k
	 * (i.e. best among top-k), you need maxToK(rl, k-1)
	 * 
	 * @param l
	 *            The rank list.
	 * @param k
