...
public class Sorter {
	 ...
	 *            The list to sort.
	 * @param asc
	 *            Ascending/Descendingly parameter.
	 * @return The sorted indexes.
	 */
	 ...
	 * @return The sorted indexes.
	 */
	private static List<Integer> qSort(List<Integer> l, List<Integer> idxList,
	        boolean asc) {
	...
	private static List<Integer> qSortString(List<String> l,
	        List<Integer> idxList, boolean asc) {
		int mid = idxList.size() / 2;
		List<Integer> left = new ArrayList<Integer>();
		List<Integer> right = new ArrayList<Integer>();
		List<Integer> pivot = new ArrayList<Integer>();
	 ...
	 * @return The sorted indexes.
	 */
	private static List<Integer> qSort(int[] l, List<Integer> idxList,
	        boolean asc) {
		int mid = idxList.size() / 2;
		List<Integer> left = new ArrayList<Integer>();
		List<Integer> right = new ArrayList<Integer>();
	 ...
	 * @return The sorted indexes.
	 */
	private static List<Integer> qSortDouble(List<Double> l,
	        List<Integer> idxList, boolean asc) {
		int mid = idxList.size() / 2;
		List<Integer> left = new ArrayList<Integer>();
		List<Integer> right = new ArrayList<Integer>();
	 ...
	 * @return The sorted indexes.
	 */
	private static List<Integer> qSortLong(List<Long> l, List<Integer> idxList,
	        boolean asc) {
		int mid = idxList.size() / 2;
		List<Integer> left = new ArrayList<Integer>();
		List<Integer> right = new ArrayList<Integer>();
